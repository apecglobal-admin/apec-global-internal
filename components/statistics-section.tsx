    ...
    <section className="rounded-2xl  bg-gray-200 p-6 sm:p-7 lg:p-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-extrabold text-blue-950 sm:text-3xl">Dashboard realtime</h2>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        {coreMetrics.map((metric) => (
          <div key={metric.title} className="rounded-2xl border border-slate-800 bg-gray-300 p-5 sm:p-6">
        ...
        <div className="rounded-2xl border border-slate-800 bg-gray-300 p-5 sm:p-6">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            {engagementMetrics.map((item) => (
              <div key={item.label} className="rounded-xl border border-slate-800 bg-white p-4">
