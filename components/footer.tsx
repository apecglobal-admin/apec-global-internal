            ...
            <div className="container mx-auto grid gap-8 px-4 py-10 lg:grid-cols-[2fr_1fr]">
                <div>
                    ...
                    >
                        ...
                        />
                        <div>
                            <div className="text-xl sm:text-2xl font-extrabold tracking-wide text-blue-600 text-shadow-lg/10">
                                APEC GLOBAL
                            </div>
                    ...
                    <h3 className="mt-2 text-2xl font-bold text-white text-shadow-lg/20">
                    ...
                    <div className="mt-4 flex flex-wrap gap-3 text-sm font-bold text-black">
                        <a
                            href="#"
                            className="rounded-full bg-gray-400/50 shadow-lg/20 border border-slate-800 px-4 py-2 hover:border-blue-500 hover:text-white"
                        >
                            Chính sách
                        </a>
                        <a
                ...
                <div className="space-y-4 text-sm text-slate-400">
                    <div>
                        <div className="uppercase tracking-[0.3em] text-blue-600">
                            Tải ứng dụng
                        </div>
