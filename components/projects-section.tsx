            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="mt-2 text-sm text-black">
                        Theo dõi mục tiêu, tiến độ và tài nguyên mỗi dự án. Dữ
                        liệu đồng bộ tự động với báo cáo PowerBI và Google Sheet
                        hàng tuần.
                    </p>
                </div>
                <a
                    href="#"
                    className="flex items-center justify-center rounded-full border border-orange-500 bg-orange-400 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white transition hover:border-blue-500 hover:text-white sm:px-5 sm:py-3 sm:text-sm md:w-auto"
                >
                    ...
                    >
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                            <div>
                                ...
                                <p className="text-sm uppercase tracking-widest font-semibold text-blue-950">
                                    {item.subtitle}
                                </p>
                                <p className="mt-3 text-sm text-black">
                                    {item.objective}
                                </p>
                                <div className="mt-4 flex flex-wrap gap-3  text-xs uppercase tracking-widest text-black">
                                    <span className="rounded-full font-bold border border-black bg-white text-black px-3 py-1">
                                        {item.phase}
                                    </span>
                                    <span className="rounded-full font-bold border border-black bg-white text-black px-3 py-1">
