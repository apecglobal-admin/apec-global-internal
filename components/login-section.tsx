    ...
    return (
        <section
            ...
            style={{
                ...
                border: "3.5px solid rgb(57, 68, 75) ",
            }}
        >
            ...
            <p className="mt-2 text-sm  text-white">
                Sử dụng tài khoản Apec ID dùng chung với ERP, HRM và CRM. Xác
                thực hai lớp bảo vệ dữ liệu và liên kết trực tiếp hồ sơ KPI,
                ...
                <div className="mt-5 space-y-4 sm:mt-6">
                    <input
                        ...
                        placeholder="Email"
                        className="w-full rounded-2xl border border-slate-800 px-4 py-3 text-sm text-black placeholder:text-slate-500
                focus:border-blue-500 focus:outline-none bg-[rgba(238,239,241,0.6)] focus:bg-white transition-colors"
                    />
...
{userInfo && (
                  ...
                  <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-white font-medium">{userInfo.department || 'Chưa cập nhật'}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-400">Chức vụ</p>
                        <p className="text-white font-medium">{userInfo.position || 'Nhân viên'}</p>
                      </div>
                    </div>
                  </div>
            ...
            <div 
            style={{background: "rgba(204, 204, 204, 0.6)"}}
            className="mt-6 grid gap-3 rounded-2xl border border-slate-800 p-5 text-sm text-white">
