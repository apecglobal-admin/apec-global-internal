...
// Cấu trúc dữ liệu cho các mục trong hệ sinh thái
const ecosystemData = {
    trainingHub: {
                ...
                <section className="mb-8 space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="max-w-3xl text-sm text-black sm:text-base">
                            Tăng tốc học tập, cộng tác và đổi mới với các trung
                            tâm dữ liệu nội bộ, công cụ làm việc nhanh và bản
                            tin cập nhật hàng tuần.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 grid gap-5 sm:gap-6 xl:grid-cols-2">
                        ...
                        <div className="rounded-2xl bg-blue-gradiant-main bg-box-shadow p-5 sm:p-6">
                            ...
                            <ul className="mt-4 space-y-2 text-sm text-slate-300">
                                {ecosystemData.trainingHub.resources.map(
                                    (item) => (
                                        <li
                                            key={item.title}
                        ...
                        <div className="rounded-2xl bg-blue-gradiant-main bg-box-shadow p-5 sm:p-6">
                            ...
                            <ol className="mt-4 list-decimal space-y-2 pl-5 text-sm text-black sm:pl-6">
                                {ecosystemData.innovationHub.steps.map(
                                    (step) => (
                                        <li key={step}>{step}</li>
                                    )
                                )}
                        ...
                        <div className="rounded-2xl bg-blue-gradiant-main bg-box-shadow p-5 sm:p-6">
                            ...
                            <div className="mt-4 space-y-3 text-sm text-slate-300">
                                {ecosystemData.weeklyDigest.highlights.map(
                                    (item) => (
                                        <div
                                            key={item.title}
