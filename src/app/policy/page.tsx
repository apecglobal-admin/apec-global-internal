...
export default function PoliciesPage() {
    ...
    const { statPolicy, listPolicy } = usePolicyData();
                    ...
                    {/* <div className="flex flex-wrap gap-2">
                        {quickLinks.map((link) => (
                            <a
                                key={link.label}
                                href={link.href}
                                className="flex items-center gap-2 rounded-full border border-orange-500  bg-orange-400 px-4 py-2 text-xs uppercase  text-white font-bold transition hover:border-gray-400 hover:bg-orange-500 hover:text-white"
                            >
                                {link.label}
