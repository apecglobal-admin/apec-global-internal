 ...
 suggestions: [
    {
      id: 1,
      type: "suggestion",
      title: "Cải thiện quy trình tuần tra ban đêm",
      category: "Process Improvement",
      date: "2024-11-01",
      status: "pending",
      description: "Đề xuất lắp thêm đèn cảm biến và chia ca hợp lý để tăng hiệu quả tuần tra",
    },
    {
      id: 2,
      type: "suggestion",
      title: "Đề xuất tập huấn kỹ năng sử dụng thiết bị PCCC",
      category: "Training",
      date: "2024-10-20",
      status: "approved",
      description: "Tổ chức buổi huấn luyện định kỳ cho toàn bộ nhân viên bảo vệ",
    },
  ],
  salaryReviews: [
    {
      id: 3,
      type: "salary",
      title: "Đề nghị tăng lương",
      requestedAmount: "10%",
      date: "2024-10-30",
      status: "under_review",
      reason: "Hoàn thành xuất sắc 50 ca tuần tra và đảm bảo an ninh tuyệt đối trong Q3",
    },
  ],
  initiatives: [
    {
      id: 4,
      type: "initiative",
      title: "Sáng kiến cải thiện báo cáo sự cố",
      category: "Innovation",
      date: "2024-10-25",
      status: "approved",
      description: "Xây dựng mẫu báo cáo sự cố chuẩn giúp giảm thời gian xử lý",
      impact: "Tiết kiệm 5 giờ/tuần cho trưởng ca",
    },
    {
      id: 5,
      type: "initiative",
      title: "Huấn luyện nhân viên mới",
      category: "Team Development",
      date: "2024-10-10",
      status: "completed",
      description: "Đào tạo kỹ năng tuần tra và xử lý sự cố cơ bản cho nhân viên mới",
      impact: "5 nhân viên mới được đào tạo",
    },
  ],
  transfers: [
    {
      id: 6,
      type: "transfer",
      title: "Đề nghị chuyển sang Trưởng ca bảo vệ",
      targetTeam: "Security Lead",
      date: "2024-10-18",
      status: "rejected",
      reason: "Cần hoàn thành thêm 30 ca tuần tra và huấn luyện nhân viên",
    },
  ],
  goals: [
    {
      id: 7,
      type: "goal",
      title: "Nâng cao kỹ năng sử dụng thiết bị giám sát",
      category: "Technical Skills",
      date: "2024-10-01",
      status: "under_review",
      description: "Học cách vận hành camera, cảm biến, báo động khẩn cấp",
    ...
    },
    {
      id: 8,
      type: "goal",
      title: "Thăng cấp Trưởng ca bảo vệ trong Q1 2025",
      category: "Career Growth",
      date: "2024-09-15",
      status: "approved",
      description: "Hoàn thành các tiêu chí tuần tra, huấn luyện và quản lý ca",
    ...
    },
    {
      id: 9,
      type: "goal",
      title: "Đảm bảo 100% an ninh khu vực văn phòng",
      category: "Performance",
      date: "2024-10-20",
      status: "pending",
      description: "Tuần tra, giám sát camera và xử lý sự cố kịp thời",
      targetDate: "2024-12-31",
      progress: 70,
    },
  ],
