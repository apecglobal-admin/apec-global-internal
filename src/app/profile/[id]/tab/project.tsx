...
const mockProjects = [
  {
    name: "Bảo vệ sự kiện Hội nghị Công ty",
    client: "Công ty ABC",
    status: "completed",
    progress: 100,
  ...
  {
    name: "Tuần tra khu vực văn phòng chính",
    client: "Trụ sở chính Công ty XYZ",
    status: "in-progress",
    progress: 60,
  ...
  {
    name: "Cài đặt và kiểm tra camera an ninh",
    client: "Tòa nhà Landmark 81",
    status: "completed",
    progress: 100,
  ...
  {
    name: "Huấn luyện nhân viên bảo vệ",
    client: "Công ty ABC",
    status: "in-progress",
    progress: 50,
    startDate: "01/12/2024",
  ...
  {
    name: "Giám sát an ninh khu vực phụ",
    client: "Chi nhánh Công ty XYZ",
    status: "paused",
    progress: 30,
