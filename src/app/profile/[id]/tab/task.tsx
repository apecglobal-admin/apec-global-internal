...
const mockTasks: {
  ...
  daily: [
    {
      id: 201,
      title: "Patrol khu vực ca sáng",
      description: "Đi tuần và kiểm tra an ninh khu vực chính",
      priority: "high",
      status: "completed",
      dueDate: "2024-12-03",
      progress: 100,
      jobs: [
        { id: 301, title: "Kiểm tra cửa ra vào", status: "completed" },
        { id: 302, title: "Ghi nhật ký tuần tra", status: "completed" },
        { id: 303, title: "Báo cáo sự cố nếu có", status: "completed" },
      ],
      exp: 40,
      isDaily: true,
    },
    {
      ...
      description: "Theo dõi camera an ninh trong ca làm việc",
      priority: "medium",
      status: "in-progress",
      dueDate: "2024-12-03",
      progress: 70,
      jobs: [
        { id: 304, title: "Kiểm tra các điểm camera", status: "completed" },
        { id: 305, title: "Phát hiện hành vi bất thường", status: "in-progress" },
      ],
      exp: 30,
      isDaily: true,
    },
    {
      ...
      description: "Đảm bảo tất cả thiết bị hoạt động bình thường",
      priority: "medium",
      status: "pending",
      dueDate: "2024-12-03",
      progress: 0,
      jobs: [
        { id: 306, title: "Kiểm tra báo động khẩn", status: "pending" },
        { id: 307, title: "Kiểm tra đèn báo sự cố", status: "pending" },
      ],
      exp: 25,
      isDaily: true,
    },
  ...
  personal: [
    {
      id: 1,
      title: "Huấn luyện kỹ năng xử lý tình huống",
      description: "Tham gia buổi đào tạo xử lý tình huống khẩn cấp",
      priority: "high",
      status: "in-progress",
      dueDate: "2024-12-15",
      progress: 50,
      jobs: [
        { id: 401, title: "Tham gia lý thuyết", status: "completed" },
        { id: 402, title: "Thực hành xử lý tình huống", status: "in-progress" },
        { id: 403, title: "Đánh giá kỹ năng", status: "pending" },
      ],
      exp: 200,
    },
    {
      id: 2,
      title: "Báo cáo tuần",
      description: "Tổng hợp sự kiện và nhật ký tuần qua",
      priority: "medium",
      status: "completed",
      dueDate: "2024-12-01",
      progress: 100,
      jobs: [
        { id: 404, title: "Thu thập dữ liệu tuần", status: "completed" },
        { id: 405, title: "Soạn báo cáo", status: "completed" },
      ],
      exp: 100,
    },
  ],
  team: [
    {
      id: 3,
      title: "Trực bảo vệ sự kiện công ty",
      description: "Hỗ trợ an ninh cho sự kiện nội bộ",
      priority: "high",
      status: "in-progress",
      dueDate: "2024-12-10",
      progress: 60,
      jobs: [
        { id: 406, title: "Phân công ca trực", status: "completed" },
        { id: 407, title: "Kiểm tra thiết bị sự kiện", status: "in-progress" },
        { id: 408, title: "Giám sát an ninh sự kiện", status: "pending" },
      ],
      exp: 150,
      assignedTo: ["Trần Văn Bảo", "Nguyễn Thị Lan"],
    },
    {
      id: 4,
      title: "Kiểm tra an ninh khu vực phụ",
      description: "Đi tuần và đảm bảo an ninh khu vực phụ",
      priority: "medium",
      status: "completed",
      dueDate: "2024-12-05",
      progress: 100,
      jobs: [
        { id: 409, title: "Đi tuần khu vực phụ", status: "completed" },
        { id: 410, title: "Báo cáo sự cố nếu có", status: "completed" },
      ],
      exp: 120,
      assignedTo: ["Trần Văn Bảo"],
    },
  ],
};
