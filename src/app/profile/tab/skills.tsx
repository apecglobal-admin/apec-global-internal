    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
      ...
      <div className="flex flex-col gap-4">
        {skillsData.map((skill: any, index: number) => (
          <div
            key={index}
            className="group pb-4 border-b border-slate-800 transition-all duration-300"
          >
            ...
            <div className="h-1.5 bg-slate-800 rounded-full overflow-hidden border border-slate-700 group-hover:border-blue-500/30 transition-colors">
              <div
