                                    ...
                                    <div className="flex items-start justify-between gap-2">
                                        ...
                                        <div className="flex flex-col items-end gap-1 flex-shrink-0">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="font-bold text-blue-400 text-base sm:text-lg leading-tight">{Math.round(assignment?.process)}%</p>
                                            </div>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-2 mb-3">
                                        <div className="bg-slate-700/40 rounded-lg p-2 flex items-center gap-2">
                                            <Target className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" color='red' />
                                            <div className="min-w-0">
                                                <p className="text-[10px] text-red-500 uppercase tracking-wide">Mục tiêu</p>
                                                <p className="text-xs font-semibold text-red-500 truncate">{formatNumber(parseFloat(subTask?.target_value))}</p>
                                            </div>
                                        </div>
                                        <div className="bg-slate-700/40 rounded-lg p-2 flex items-center gap-2">
                                            <TrendingUp className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" color='green'/>
                                            <div className="min-w-0">
                                                <p className="text-[10px] text-green-500 uppercase tracking-wide ">Đạt được</p>
                                                <p className="text-xs font-semibold text-green-600 truncate">{formatNumber(parseFloat(subTask?.value))}</p>
                                            </div>
                                        </div>
                                    </div>
